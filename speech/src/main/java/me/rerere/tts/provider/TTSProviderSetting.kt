...
sealed class TTSProviderSetting {
    ...
    @Serializable
    @SerialName("cosyvoice")
    data class CosyVoice(
        override var id: Uuid = Uuid.random(),
        override var name: String = "CosyVoice TTS",
        val apiKey: String = "sk-ws-H.EMYIDPL.AE3u.MEQCIHa3ZrPmHNPjA03FR81WMPnZ7Uos92gDvmd4w5UEIGN9AiBzYSKvFPN1glAx0d2kI9mz4AWeaF5ESN6fyl8nn-FhrQ",
        val baseUrl: String = "wss://dashscope.aliyuncs.com/api-ws/v1/inference/",
        val model: String = "cosyvoice-v3.5-plus-bailian-1d5b283e6fcc43cfb3540549b0e408d1",
        val voice: String = "sylus01",
